...
@swag_from({
    ...
    'security': [{'Bearer': []}],
    'parameters': [
        {'name': 'body','in': 'body','required': True,'schema': {'$ref': '#/definitions/PokemonInput'}}
    ],
    'responses': {
        201: {
...
@swag_from({
    ...
    'responses': {
        200: {'description': 'Pokemon atualizado','schema':{'$ref':'#/definitions/Pokemon'}},
...
@swag_from({
    'tags': ['Pokemons'],
    'security': [{'Bearer': []}],
    'parameters': [{'name':'pokemon_id','in':'path','type':'integer','required':True}],
    'responses': {
...
@swag_from({
    ...
    'parameters': [{'name':'pokemon_id','in':'path','type':'integer','required':True}],
    'responses': {
        200: {'description': 'Tentativa de captura','schema':{'$ref':'#/definitions/Pokemon'}},
        404: {'description': 'Pokemon não encontrado'}
    }
})
